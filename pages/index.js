      ...
      <section className="featured">
        <div className="container">
          ...
          <article style={{backgroundImage: 'url(/images/featured-2.jpg)'}} className="featured-item featured-item-small-first">
            <div className="featured-item__content">
              <h3>Basic t-shirts 1.99 MATIC</h3>
          ...
          <ul className="shop-data-items">
            <li>
              ...
              <div className="data-item__content">
                <h4>Free Shipping</h4>
                <p>All purchases over 25 MATIC are eligible for free shipping via USPS First Class Mail.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                <h4>Easy Payments</h4>
                <p>All payments are processed instantly over a secure payment protocol by Paybae!</p>
              </div>
            </li>
