    ...
    <section className='product-content'>
      <div className='product-content__intro'>
        ...
        <div className='product__prices'>
          <h4>{product.currentPrice} MATIC</h4>
          {product.discount && <span>{product.price} MATIC</span>}
        </div>
      </div>
        ...
        <div className='product-filter-item'>
          ...
          <div className='checkbox-color-wrapper'>
            {productsColors.map((type) => (
              <CheckboxColor key={type.id} type={'radio'} name='product-color' color={type.color} valueName={type.label} onChange={onColorSet} />
            ))}
          </div>
        </div>
        <div className='product-filter-item'>
